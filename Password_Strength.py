...
path = os.path.join(my_path, "Dictionarywords.txt")
f = open(path,'r')
...
class passwordstrength:
    ...
    def __repeating_chars_score(self):
        ...
        self.__table_print('repeating characters', repeating_char_count,
                           -repeating_char_count*3)
        
        return -repeating_char_count #Multiplied with 3 by the WA works
    ...
    def get_readable_score(self):
        if self.score < 30 :
            return 'Very weak'
        elif self.score >= 30 and self.score < 54:
            return 'Weak'
        elif self.score >= 54 and self.score < 80:
            return 'OK'
        elif self.score >= 80 and self.score < 99:
            return 'Strong'
